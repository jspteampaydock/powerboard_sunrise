export function powerboardMapperDataHelper() {

    const powerboardConvertAddress = (data) => {
        return {
    ...
    const powerboardConvertCartItems = (cartItems) => {
        if (cartItems?.length) {
    ...
    return {
        powerboardConvertAddress,
        powerboardConvertCartItems,
    };
}
